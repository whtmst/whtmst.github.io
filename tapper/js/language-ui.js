...
export function createLanguageUI(
    ...
    function applyLanguage(language) {
        ...
        if (globalTapKeyLabel) {
            globalTapKeyLabel.textContent =
                text.globalTapKey || "Global Tap Key";
        }
        ...
        if (desktopDownloadText) {
            desktopDownloadText.textContent =
                text.desktopAppAvailable || "Desktop app available";
        }

        if (desktopDownloadLink) {
            desktopDownloadLink.textContent = text.download || "Download";
        }
